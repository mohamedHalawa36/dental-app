...
export default function ConnectionLost({ className }: IconProps) {
  return (
    <svg
      version="1.1"
      id="Capa_1"
    ...
    >
      <g>
        <g>
          ...
          <path
            d="M561.7,401c-15.801-10.3-32.601-19.2-50.2-26.6c-39.9-16.9-82.3-25.5-126-25.5c-44.601,0-87.9,8.9-128.6,26.6
          ...
          />
          <path
            d="M385.6,267.1c107.601,0,208.9,41.7,285.3,117.4l98.5-99.5c-50-49.5-108.1-88.4-172.699-115.6
          ...
          <polygon
            ...
            points="616.8,402.5 549.7,469.599 639.2,559.099 549.7,648.599 616.8,715.7 706.3,626.2 795.8,715.7 862.899,648.599 
